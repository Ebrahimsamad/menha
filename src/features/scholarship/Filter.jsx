...
export default function Sidebar({ isOpen, setIsOpen }) {
    ...
    const handleFilter = (e) => {
        ...
        if (selectedFieldOfStudy) params.append('fieldOfStudy', selectedFieldOfStudy);
        if (selectedModeOfStudy) params.append('modeOfStudyId', selectedModeOfStudy);
    ...
    return (
        <div
            className={`sticky top-0 z-50 bg-white border-r border-r-border-base shadow-lg transition-all duration-300 ${isOpen ? 'w-full md:w-96' : 'w-0 lg:w-24'} h-screen`}
        >
            <button
            ...
            >
                <div className='flex justify-between'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d={isOpen ? "M15.75 19.5 8.25 12l7.5-7.5" : "M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75"} />
                    </svg>
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <fieldset className="w-full">
                                            <legend className="block text-sm font-medium">
                                                <div className='flex mb-3 text-[#003a65]'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v15.6m0 0L4.5 12m7.5 6.6L19.5 12m-7.5 0L12 3m0 15.6L19.5 12m-7.5 6.6L4.5 12" />
                                                    </svg>
                                        ...
                                        <div className="flex flex-col w-full  justify-between mt-4 space-y-2 ">
                                            <PrimaryButton type="submit" disabled={loading}>Filter</PrimaryButton>
